...
function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // First attempt login with Identity's built-in endpoint
            ...
            // After successful login, fetch user details to get the ID
            try {
                const profileResponse = await fetch('https://localhost:5000/account/me', {
                    credentials: 'include'
                });
                ...
                if (profileResponse.ok) {
                    ...
                    console.log('User data stored in localStorage:', profileData);
                } else {
