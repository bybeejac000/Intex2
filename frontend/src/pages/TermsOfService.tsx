      ...
      <div className="privacy-container">
        ...
        <main className="privacy-main">
          ...
          <section id="introduction">
            ...
            <p>
              Welcome to CineNiche! By accessing or using our platform, you agree to be bound by these Terms of Service. 
              These terms govern your use of our website and services and outline your rights and responsibilities as a user.
            </p>
          </section>
          ...
          <section id="acceptance">
            ...
            <p>
              By creating an account or using CineNiche, you acknowledge that you have read, understood, and agree to these Terms. 
          ...
          <section id="userContent">
            ...
            <p>
              CineNiche allows you to leave reviews for movies and share your opinions. By submitting reviews or other content, 
          ...
          <section id="reviewPolicy">
            ...
            <p>
              We encourage honest, constructive reviews. However, CineNiche reserves the right to remove content that is found 
              to be abusive, defamatory, or in violation of any applicable laws or guidelines.
            </p>
          </section>
          ...
          <section id="prohibited">
            ...
            <ul>
              ...
              <li>Engaging in activities that could harm or exploit other users.</li>
            </ul>
          </section>
          ...
          <section id="intellectualProperty">
            ...
            <p>
              All content on CineNiche, including design, text, logos, images, and graphics, is protected by intellectual property laws. 
          ...
          <section id="limitation">
            ...
            <p>
              CineNiche is provided “as is” without warranties of any kind. We do not guarantee uninterrupted service or freedom 
              from errors. In no event shall CineNiche or its contributors be liable for any damages arising out of your use of the service.
            </p>
          </section>
